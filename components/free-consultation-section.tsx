...
type FreeConsultationField = 'name' | 'address' | 'email' | 'phone' | 'message'
...
export default function FreeConsultationSection() {
  ...
  const [errors, setErrors] = useState<Partial<Record<FreeConsultationField | 'verified', string>>>({})

  const validateField = (name: FreeConsultationField, value: string) => {
    switch (name) {
      case 'name':
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => {
    const { name, value } = e.target as { name: FreeConsultationField; value: string }
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const nextErrors: Partial<Record<FreeConsultationField | 'verified', string>> = {
    ...
    console.log('Free consultation form submitted:', formData)
    ...
    <section className="bg-background">
      <div className="relative min-h-[300px] overflow-hidden sm:min-h-[380px]">
        <Image
          ...
          alt="Marigold Pharmacy consultation banner"
          fill
          quality={100}
        ...
        <div className="absolute inset-x-0 bottom-0 bg-white/58 backdrop-blur-[2px]">
          <div className="mx-auto max-w-6xl px-4 py-6 text-center sm:px-6 sm:py-7 lg:px-8">
            <h1 className="text-4xl font-light tracking-tight text-primary sm:text-5xl">
              Contact Us
            </h1>
          </div>
        </div>
      ...
      <div className="mx-auto max-w-6xl px-4 py-10 sm:px-6 sm:py-12 lg:px-8">
        <div className="animate-rise-in">
          ...
          <h2 className="mt-10 text-4xl font-light tracking-tight text-primary sm:text-5xl">
            Need help?
          </h2>
          <p className="mt-5 max-w-4xl text-lg leading-relaxed text-foreground/85 sm:text-xl">
            ...
            <div className="mt-8 grid gap-6">
              <label className="grid gap-2">
                ...
                <input
                  ...
                  aria-describedby={errors.name ? 'free-consult-name-error' : undefined}
                />
                <FieldError id="free-consult-name-error" message={errors.name} />
              </label>
              ...
              <label className="grid gap-2">
                ...
                <input
                  ...
                  aria-describedby={errors.address ? 'free-consult-address-error' : undefined}
                />
                <FieldError id="free-consult-address-error" message={errors.address} />
              </label>
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-5">
                <label className="grid gap-2">
                  ...
                  <input
                    ...
                    aria-describedby={errors.email ? 'free-consult-email-error' : undefined}
                  />
                  <FieldError id="free-consult-email-error" message={errors.email} />
                </label>
                ...
                <label className="grid gap-2">
                  ...
                  <input
                    ...
                    aria-describedby={errors.phone ? 'free-consult-phone-error' : undefined}
                  />
                  <FieldError id="free-consult-phone-error" message={errors.phone} />
                </label>
              </div>
              ...
              <label className="grid gap-2">
                ...
                <textarea
                  ...
                  aria-describedby={errors.message ? 'free-consult-message-error' : undefined}
                />
                <FieldError id="free-consult-message-error" message={errors.message} />
              </label>
              ...
              <div className="flex flex-col gap-4 pt-2 md:flex-row md:items-end">
                <div className="w-full max-w-[320px] overflow-hidden rounded-md border border-border bg-white shadow-sm">
                  ...
                  <div className="border-t border-border bg-muted/55 px-4 py-2 text-[10px] text-muted-foreground">
                    Interactive verification field
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <FieldError id="free-consult-verified-error" message={errors.verified} />
                </div>
              </div>
            </div>
          </form>
