    ...
    <section className="bg-background">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-12">
        <div className="animate-rise-in">
          ...
          <h2 className="mt-10 text-4xl sm:text-5xl font-light text-primary tracking-tight">
            Need help?
          </h2>
          <p className="mt-5 max-w-4xl text-lg sm:text-xl leading-relaxed text-foreground/85">
