              ...
              <div className="grid grid-cols-1 lg:grid-cols-[0.96fr_1.04fr] gap-6 items-start">
                <div className="overflow-hidden rounded-[1.5rem] border border-primary/15 bg-white shadow-xl">
                  <div className="relative min-h-[300px] sm:min-h-[380px]">
                    <Image
                      src="/seasonal-vaccinations-detail.png"
                      alt="Doctor injecting flu vaccine to patient's arm"
                      fill
                      quality={100}
                ...
                <div>
                  ...
                  <p className="mt-5 text-base sm:text-lg leading-relaxed text-foreground/80">
                    At <span className="font-semibold text-secondary">Marigold Pharmacy</span>, we encourage you and your loved ones to get vaccinated before the flu season as soon as possible. This way, you can help build up immunity against viruses, not just in your home but in the community as well.
                  </p>
                  <p className="mt-4 text-base sm:text-lg leading-relaxed text-foreground/80">
                    We have qualified pharmacists who can give you and your family the recommended flu shots for the season.
                  </p>
                  ...
                  <div className="mt-6 rounded-2xl bg-secondary/8 p-5 ring-1 ring-secondary/10">
                    ...
                    <p className="mt-3 text-base sm:text-lg leading-relaxed text-foreground/80">
                      To explore your options for our cold and flu products, just drop by our pharmacy and our pharmacist will gladly assist you with what you need. We can provide flu advice as well for your family.
                    </p>
                  </div>
                </div>
              </div>
